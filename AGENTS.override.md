...
- Treat everything under `sources/` as read-only. Never edit, rename, move, or delete it.
- Preserve original recordings, screenshots, exports, and course materials. Put derived notes in `docs/`, not beside or over the source.
- Do not invent missing chat content, measurements, skill levels, deadlines, or source claims.
- Clearly distinguish confirmed facts, working hypotheses, and open questions.
- Do not reproduce complete copyrighted lyrics, tabs, books, or course material. Store original analysis, short necessary excerpts, practice cues, and links instead.

## Teaching and writing style

- Default to Chinese unless the user requests another language.
- Prefer a bottom-up explanation: physical or structural model -> audible effect -> instrument or vocal application -> short exercise.
- Use mathematics and physics when they clarify the mechanism, but never imply that they fully explain perception, culture, style, or expression.
